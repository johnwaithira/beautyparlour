...
?>
  <title>Beauty Pala</title>
    <div class="scroll-top">
        <p class="scroll-top-btn"> <span>&#10096;</span></p>
    </div>
    <?php include "../nav.php";?>
        ...
        <div class="info-wrapper s">
            ...
            if($services->num_rows < 0)
            {
                ...
                while($service_data = $services->fetch_assoc()){  ?>
                    ...
                    <a href="<?php echo BASE_URL;?>/book/?s_id=<?php echo $service_data['service_id'];?>">
    ...
    <div class="more-info x">
        <div class="info-wrapper s ">
            ...
            <div class="my-info display-flex-ordinary">
                <style>.display-flex-ordinary{flex-wrap:wrap;}</style>
                <?php
